...
import { Container, Form, Button, Alert, Card, Spinner, Badge, Row, Col } from 'react-bootstrap';
...
const CreatePost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!coverImage) {
            setError('Carica un\'immagine di copertina');
            return;
        }
        ...
        try {
            ...
            setError(err.response?.data?.message || 'Errore durante la creazione del articolo');
        } finally {
            setSaving(false);
        }
    };
        ...
        <Container className="py-5">
            <Card className="shadow-sm border-0">
                <Card.Body className="p-4">
                    <h1 className="text-center mb-4">Crea Nuovo Articolo</h1>
